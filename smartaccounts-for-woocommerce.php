 ...
 *
 * Copyright: (c) 2025, Konekt Ltd (info@konekt.ee)
 *
...
class Konekt_WC_SmartAccounts {
	...
	public const FRAMEWORK_VERSION = '5.15.2';


	/** the plugin name, for displaying notices */
	public const PLUGIN_NAME = 'SmartAccounts for WooCommerce';


	/** @var Konekt_WC_SmartAccounts single instance of this class */
	private static ?Konekt_WC_SmartAccounts $instance = null;
	...
	public function init_plugin() {
		...
		$loader->addPsr4( 'Konekt\\WooCommerce\\SmartAccounts\\', __DIR__ . '/includes' );

		require_once plugin_dir_path( __FILE__ ) . 'includes/Functions.php';

		// fire it up!
		konekt_wc_smartaccounts();
	}
	...
	/**
	 * Displays any admin notices added with \Konekt_WC_SmartAccounts::add_admin_notice()
	 *
	 * @internal
	 *
	 * @since 1.0.0
	...
	/**
	 * Gets the main \Konekt_WC_SmartAccounts instance.
	 *
	 ...
	 */
	public static function instance() : Konekt_WC_SmartAccounts {
...
// fire it up!
Konekt_WC_SmartAccounts::instance();
